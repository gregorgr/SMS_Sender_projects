public class Kosara extends Posoda
{
	...
	public Kosara()
	{
		super(10,1);	// Ker v razredu posoda nismo definirali praznega konstruktorja, moramo tukaj klicati tistega, ki je definiran v nadrazredu.
		this.stRdecihKrompirjev = 0;
		this.stBelihKrompirjev = 0;
	}

	public Kosara(int stBelih, int stRdecih)
	{
		super(10,1); // Ker v razredu posoda nismo definirali praznega konstruktorja, moramo tukaj klicati tistega, ki je definiran v nadrazredu.
		this.stRdecihKrompirjev = stRdecih;
		this.stBelihKrompirjev = stBelih;
	}
	...
	public void izpis()
	{
		...
		System.out.println("Splošne lastnosti košare: ");
		System.out.println("Volumen: " + getVolumen());
		System.out.println("Teža: " + getTeza());
