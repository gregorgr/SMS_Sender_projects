...
public class Clovek
{
	...
	public Clovek(double t, int s, String bl) // Še en konstruktor, ki pa dobi parametre za vrednosti lastnosti èloveka, ki ga ustvari.
	{
		this.teza = t;
		this.starost = s;
		this.barvaLas = bl;
	...
	public static void main(String[] args) // Metodo main za potrebe testiranja ustvarimo kar v tem razredu.
	{
		...
		Clovek terezija = new Clovek(60.0, 23, "rdeèa");
