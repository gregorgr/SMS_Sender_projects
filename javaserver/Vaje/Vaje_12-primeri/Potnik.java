...
public class Potnik
{
	...
	/*
	 *	Metoda zapiše podatke o potniku v poseben niz, iz katerega znamo enolièno razbrati, za katerega potnika gre.
	 *  Implementiramo jo kot objektno metodo
	 */
	public String shraniKotNiz()
	{
		String zapis = "*P\r\n";		// Zapišemo kodo "P", ki oznaèuje potnika
		zapis += this.ime + "\r\n";		// Zapišemo ime
		zapis += this.starost + "\r\n";	// Zapišemo starost
		zapis += this.voznik + "\r\n";		// Zapišemo ali je voznik
		zapis += "#\r\n";				// Z '#' oznaèimo konec branja
		return zapis;
	}
