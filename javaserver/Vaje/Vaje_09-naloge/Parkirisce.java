...
public class Parkirisce
{
	...
	public int dodajIzDatoteke(String imeDatoteke) throws Exception
	{
		...
		while(dat.ready())
		{
			...
			if(vrstica.equals("*A"))	// Èe se vrstica zaène z *A, zaènemo brati podatke za avto
			{
				...
				{
					System.out.println("Avto z registracijo " + novAvto.getRegistracija() + " že obstaja, zato ne bo dodan.");
				}
			}
		}
		dat.close();
